...
E_change =[2092.08	2315.6	2244.82	2189.27	2126.4	2066.59	2005.52	1934.71	1876.53	1818.33	1759.1	1690.13	1632.18	1575.01	1520.07	1466.25	2603.95
];
%I = 0.2*round*I;
%E = 0.2*round*E;
...
save(strcat(cd,'/result/MV.mat'), 'I_result','E_result','R_result');

index = max(I_result);
I_peak = [I_peak;index];
save(strcat(cd,'/result/MV_I_peak.mat'), 'I_peak');
