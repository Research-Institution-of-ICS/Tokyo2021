...
E_change =[2501.61	3848.11	3835.84	3474.73	3134.09	2811.35	2520.55	2267.32	2011.57	1783.99	1582.39	1403.54	1247.28	1107.11	978.79	862.86	775.66
];
%I = 0.2*round*I;
%E = 0.2*round*E;
...
save(strcat(cd,'/result/RL1.mat'), 'I_result','E_result','R_result');

index = max(I_result);
I_peak = [I_peak;index];
save(strcat(cd,'/result/RL1_I_peak.mat'), 'I_peak');
