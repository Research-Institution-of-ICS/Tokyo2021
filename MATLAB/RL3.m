...
E_change =[1040.87	1131.8	1209.58	1371.09	1545.82	1732.11	1900.05	2046.96	2177.41	2289.22	2374.28	2434.98	2468.38	2474.45	2452.12	2414.21	3944.17
];
%I = 0.2*round*I;
%E = 0.2*round*E;
...
save(strcat(cd,'/result/RL3.mat'), 'I_result','E_result','R_result');

index = max(I_result);
I_peak = [I_peak;index];
save(strcat(cd,'/result/RL3_I_peak.mat'), 'I_peak');
