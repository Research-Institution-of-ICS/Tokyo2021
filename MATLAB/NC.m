...
E_change =[1364.61	1639.44	1986.3	2336.52	2665.05	2990.32	3276.88	3532.86	3750.27	3923.19	4040.4	4105.88	4131.3	4110.86	4053.96	3985.99	3912.83	
];
%I = 0.2*round*I;
%E = 0.2*round*E;
...
save(strcat(cd,'/result/NC.mat'), 'I_result','E_result','R_result');

index = max(I_result);
I_peak = [I_peak;index];
save(strcat(cd,'/result/NC_I_peak.mat'), 'I_peak');
