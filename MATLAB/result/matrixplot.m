...
processeddata = (data-mindata)/rangedata;   %源数据归一化
relativedata = data/maxdata;   %用0-1的相对值
if isnan(rangedata)
...
if strncmpi(FillStyle,'Fill',3)
    MyPatch(sx',sy',processeddata',FigShape,FigSize);
end
...
if strncmpi(ColorBar,'On',2)
    ...
    kk =mindata:rangedata/10:maxdata;
    set(h,'xticklabel',kk)
end
end
