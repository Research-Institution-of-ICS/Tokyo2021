...
E_change =[1178.86	1418.92	1585.82	1797.4	2029.09	2259.62	2461.68	2634.46	2775.47	2903.86	2988.75	3047.31	3062.04	3049.5	3023.87	2971.45	4971.73
];
%I = 0.2*round*I;
%E = 0.2*round*E;
...
save(strcat(cd,'/result/RL2.mat'), 'I_result','E_result','R_result');

index = max(I_result);
I_peak = [I_peak;index];
save(strcat(cd,'/result/RL2_I_peak.mat'), 'I_peak');
