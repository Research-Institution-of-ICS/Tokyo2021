...
for round = 1:10
    ...
    save(strcat(cd,'/result/sensitivity/betaplane/result',num2str(round),'.mat'), 'I_result','E_result','R_result');
    
    index = max(I_result);
    I_peak = [I_peak;index];
end
save(strcat(cd,'/result/sensitivity/betaplane/I_peak.mat'), 'I_peak');
